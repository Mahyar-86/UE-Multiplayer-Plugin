...
void AMenuSystem_EOS_SteamCharacter::NotifyControllerChanged()
{
...
void AMenuSystem_EOS_SteamCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMenuSystem_EOS_SteamCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMenuSystem_EOS_SteamCharacter::Look);
	}
	else
	{
...
void AMenuSystem_EOS_SteamCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMenuSystem_EOS_SteamCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
